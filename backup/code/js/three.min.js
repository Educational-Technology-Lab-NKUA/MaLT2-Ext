...
THREE.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*e.autoRotateSpeed}
function d(a){
...
if(!showGrid){
				...
				scene.add(gridXZ);
						...
						scene.add(gridYZ);
				showGrid = true;			  }	
				i.set(a.clientX,a.clientY);j.sub(i,h);e.rotateLeft(2*Math.PI*j.x/g*e.userRotateSpeed);e.rotateUp(2*Math.PI*j.y/g*e.userRotateSpeed);
				h.copy(i)}else if(t===s.ZOOM){o.set(a.clientX,a.clientY);m.sub(o,l);m.y>0?e.zoomIn():e.zoomOut();l.copy(o)}}
function dTouch(a){
		a.preventDefault();
	if(t===s.ROTATE){
var touchobj = a.changedTouches[0]
if(!showGrid){
				...
				scene.add(gridXZ);
						...
						scene.add(gridYZ);
				showGrid = true;			  }	
				i.set(touchobj.clientX,touchobj.clientY);j.sub(i,h);e.rotateLeft(2*Math.PI*j.x/g*e.userRotateSpeed);e.rotateUp(2*Math.PI*j.y/g*e.userRotateSpeed);
				h.copy(i)}else if(t===s.ZOOM){o.set(touchobj.clientX,touchobj.clientY);m.sub(o,l);m.y>0?e.zoomIn():e.zoomOut();l.copy(o)}}
				function f(){console.log ("mouseUp");if(e.userRotate){
					document.removeEventListener("mousemove",d,false);
					document.removeEventListener("mouseup",f,false);

				t=s.NONE}}
function fTouch(){console.log ("touchUp");if(e.userRotate){
					document.removeEventListener("touchend",fTouch,false); 
					document.removeEventListener("touchmove",dTouch,false);
t=s.NONE}
}

THREE.EventTarget.call(this);
this.object=a;this.domElement=b!==void 0?b:document;this.center=new THREE.Vector3;this.userZoom=true;this.userZoomSpeed=1;
this.userRotate=true;this.userRotateSpeed=1;this.autoRotate=false;this.autoRotateSpeed=2;var e=this,g=1800,h=new THREE.Vector2,i=new THREE.Vector2,j=new THREE.Vector2,l=new THREE.Vector2,o=new THREE.Vector2,m=new THREE.Vector2,p=0,q=0,n=1,r=new THREE.Vector3,s={NONE:-1,ROTATE:0,ZOOM:1},t=s.NONE,u={type:"change"};this.rotateLeft=function(a){a===
void 0&&(a=c());q=q-a};this.rotateRight=function(a){a===void 0&&(a=c());q=q+a};
this.rotateUp=function(a){a===void 0&&(a=c());p=p-a};this.rotateDown=function(a){a===void 0&&(a=c());p=p+a};
this.zoomIn=function(a){a===void 0&&(a=Math.pow(0.95,e.userZoomSpeed));n=n/a};this.zoomOut=function(a){a===void 0&&(a=Math.pow(0.95,e.userZoomSpeed));n=n*a};this.update=function(){var a=this.object.position,b=a.clone().subSelf(this.center),d=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&
...
this.domElement.addEventListener("mousedown",function(a){console.log ("mouse/touch down");
if(e.userRotate){a.preventDefault();
if(a.button===0||a.button===2){t=s.ROTATE;h.set(a.clientX,a.clientY)}else if(a.button===1){t=s.ZOOM;l.set(a.clientX,a.clientY)}
document.addEventListener("mousemove",d,false);

document.addEventListener("mouseup",f,false);

}},false);
this.domElement.addEventListener("touchstart",function(a){console.log ("mouse/touch down");
if(e.userRotate){a.preventDefault();
var touchobj = a.changedTouches[0]
t=s.ROTATE;h.set(touchobj.clientX,touchobj.clientY)
document.addEventListener("touchmove",dTouch,false);
document.addEventListener("touchend",fTouch,false);
}},false);
this.domElement.addEventListener("mousewheel",function(a){e.userZoom&&(a.wheelDelta>0?e.zoomOut():e.zoomIn())},false)};
