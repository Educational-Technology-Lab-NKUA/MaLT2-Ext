...
function calculateSliderValue (canvasX, canvasY){
	if(tdaxisY!=null){
	sliderStepY = parseInt(document.getElementById(tdaxisY+"_step").value);
	sliderMinY = parseInt(document.getElementById(tdaxisY+"_min").value);
	sliderMaxY = parseInt(document.getElementById(tdaxisY+"_max").value);
	...
	if (tdaxisX !=null){
	sliderStepX = parseInt(document.getElementById(tdaxisX+"_step").value);
	sliderMinX = parseInt(document.getElementById(tdaxisX+"_min").value);
	sliderMaxX = parseInt(document.getElementById(tdaxisX+"_max").value);
